...
from src.model.holdemRecordManagement import newHoldemRecord, removeHoldemRecord, getHoldemRecord, setHoldemRecordStatus, addMoneyToHoldemRecord
...
def test_():
    ...
    assert addMoneyToHoldemRecord(db, 123, tableUUID, 100)
